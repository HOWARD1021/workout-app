...
var BuildId = "njqr-IItAk_Bi_AfVHZ1H";
var HtmlPages = ["/404"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/analytics", "regex": "^/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/analytics(?:/)?$" }, { "page": "/exercises", "regex": "^/exercises(?:/)?$", "routeKeys": {}, "namedRegex": "^/exercises(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/log", "regex": "^/log(?:/)?$", "routeKeys": {}, "namedRegex": "^/log(?:/)?$" }], "dynamic": [{ "page": "/api/templates/[id]", "regex": "^/api/templates/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/templates/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/api/exercises/route": "/api/exercises", "/api/exercises/previous/route": "/api/exercises/previous", "/api/templates/[id]/route": "/api/templates/[id]", "/api/templates/route": "/api/templates", "/api/workouts/route": "/api/workouts", "/_not-found/page": "/_not-found", "/favicon.ico/route": "/favicon.ico", "/analytics/page": "/analytics", "/log/page": "/log", "/exercises/page": "/exercises", "/page": "/" };
