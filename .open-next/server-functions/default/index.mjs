...
var BuildId = "939ahEPN2Dm64ogSAXR-F";
var HtmlPages = ["/404"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/analytics", "regex": "^/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/analytics(?:/)?$" }, { "page": "/exercises", "regex": "^/exercises(?:/)?$", "routeKeys": {}, "namedRegex": "^/exercises(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/log", "regex": "^/log(?:/)?$", "routeKeys": {}, "namedRegex": "^/log(?:/)?$" }, { "page": "/templates", "regex": "^/templates(?:/)?$", "routeKeys": {}, "namedRegex": "^/templates(?:/)?$" }], "dynamic": [{ "page": "/api/templates/[id]", "regex": "^/api/templates/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/templates/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/exercises/route": "/api/exercises", "/api/templates/route": "/api/templates", "/api/templates/[id]/route": "/api/templates/[id]", "/api/exercises/previous/route": "/api/exercises/previous", "/api/workouts/route": "/api/workouts", "/favicon.ico/route": "/favicon.ico", "/analytics/page": "/analytics", "/page": "/", "/log/page": "/log", "/templates/page": "/templates", "/exercises/page": "/exercises" };
